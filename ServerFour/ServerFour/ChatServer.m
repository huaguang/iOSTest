...
- (void) stream:(NSStream*)stream handleEvent:(NSStreamEvent)eventCode {
    switch (eventCode) {
        ...
        case NSStreamEventHasBytesAvailable: {
            Client *client = [self.clients objectForKey:[NSString stringWithFormat:@"%@",stream]];
            ...
            if ([data length] == 0) {
                ...
                [self.clients removeObjectForKey:[NSString stringWithFormat:@"%@",stream]];
    ...
    if (kCFSocketAcceptCallBack == type) {
        ...
        if(NULL != readStream && NULL != writeStream) {
            ...
            [theChatServer.clients setValue:aClient
                                     forKey:[NSString stringWithFormat:@"%@",inputStream]];
